...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("cpp",(()=>{"use strict";return e=>{const t=(e=>{
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("c",(()=>{"use strict";return e=>{const t=(e=>{
function t(e){return"(?:"+e+")?"}var n=e.COMMENT("//","$",{contains:[{
begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+t(r)+"[a-zA-Z_]\\w*"+t("<.*?>")+")",i={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},s={className:"string",
...
contains:[{beginKeywords:"final class struct"},e.TITLE_MODE]}]),exports:{
preprocessor:o,strings:s,keywords:u}}})(e)
;return t.name="C",t.aliases=["c","h"],t}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
